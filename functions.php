...
Class CodeSpire_FrameWork {
    ...
    function cs_style_and_scripts() {
        ...
        wp_enqueue_script( 'guyFramework', get_stylesheet_directory_uri() . '/assets/js/guyFramework.js', array('jquery'), '1.0.0', true );
        wp_enqueue_script( 'scripts', get_stylesheet_directory_uri() . '/assets/js/scripts.js', array('jquery'), '1.0.0', true );
